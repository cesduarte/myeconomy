<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="InvestimentoManual.aspx.cs" Inherits="MyEconomy.InvestimentoManual" %>
                        ...
                        <div class="row">
                            <div class="col p-md-0">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Movimentação / Investimento manual </a></li>
                                </ol>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <ul class="mb-0 form-profile__icons">
                                                    ...
                                                    <li class="d-inline-block">
                                                        <button type="button" class="btn btn-outline-light" title="Novo Investimento manual" data-toggle="modal" data-target="#CadastroModal"><i class="fa fa-plus"></i></button>
                    ...
                    <div class="bootstrap-modal">
                     ...
                     <div class="modal fade bd-example-modal-lg" id="CadastroModal"  data-keyboard="false" data-backdrop="static" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Investimento manual</h5>
