...
(select COALESCE(sum(ValorOcorrencia),0) from tbl_extratobancario b where StatusOcorrencia = 'Investimento débito' and b.Idcontasbancarias= a.Idcontasbancarias and DataOcorrencia BETWEEN 
