                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <ul class="mb-0 form-profile__icons">
                                                    ...
                                                    <li class="d-inline-block">
                                                        <button type="button" class="btn btn-outline-light" title="Novo conta bancária" data-toggle="modal" data-target="#CadastroModal"><i class="fa fa-plus"></i></button>

                                                    </li>
                                                    <li class="d-inline-block">
                                                        <button type="button" class="btn btn-outline-light" title="Pesquisar Contas bancárias" data-toggle="modal" data-target="#basicModal"><i class="fa fa-search"></i></button>
                                                    </li>
