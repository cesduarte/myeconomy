<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ContasBancarias.aspx.cs" Inherits="MyEconomy.ContasBancarias" %>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <ul class="mb-0 form-profile__icons">
                                                    ...
                                                    <li class="d-inline-block">
                                                        <button type="button" class="btn btn-transparent p-0 mr-3" title="Novo conta bancária" data-toggle="modal" data-target="#CadastroModal"><i class="fa fa-plus"></i></button>

                                                    </li>
                                                    <li class="d-inline-block">
                                                        <button type="button" class="btn btn-transparent p-0 mr-3" title="Pesquisar Contas bancárias" data-toggle="modal" data-target="#basicModal"><i class="fa fa-search"></i></button>
                                                    </li>
