    ...
    public class ClassificacaoDAL
    {
        ...
        public List<ClassificacaoInformation> CarregarClassificacao(string IdClassificacao)
        {
            try
            {
                ...
                {
                    ListaDeDados.Add(new ClassificacaoInformation() { IdClassificacao = int.Parse(dataRow["Idclassificacao"].ToString()), DescricaoClassificacao = dataRow["DescricaoClassificacao"].ToString(), Isdelete = Convert.ToBoolean(dataRow["Isdelete"].ToString()) });
                }
