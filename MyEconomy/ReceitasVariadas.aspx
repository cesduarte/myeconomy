<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ReceitasVariadas.aspx.cs" Inherits="MyEconomy.ReceitasVariadas" %>
                        ...
                        <div class="row">
                            <div class="col p-md-0">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Movimentação / Receita </a></li>
                                </ol>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <ul class="mb-0 form-profile__icons">
                                                    ...
                                                    <li class="d-inline-block">
                                                        <button type="button" class="btn btn-outline-light" title="Nova Receita" data-toggle="modal" data-target="#CadastroModal"><i class="fa fa-plus"></i></button>

                                                    </li>
                                                    <li class="d-inline-block">
                                                        <button type="button" class="btn btn-outline-light" title="Pesquisar Receitas" data-toggle="modal" data-target="#basicModal"><i class="fa fa-search"></i></button>
                                                    </li>
                                    ...
                                    <asp:UpdatePanel ID="upcontas" runat="server">
                                        <ContentTemplate>
                                            <asp:GridView ID="GrdDados" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered"
                                                ...
                                                <Columns>
                                                    <asp:BoundField DataField="Descricaoreceitavariada" HeaderText="Descrição receita" />
                                                    ...
                                                    <asp:BoundField DataField="ValorreceitaVariada" HeaderText="Valor" DataFormatString="{0:c}" />

                                                    <asp:BoundField DataField="DatareceitaVariada" HeaderText="Data receita" DataFormatString="{0:dd/MM/yyyy}" />
                                                    ...
                                                    <asp:TemplateField>
                                                        <ItemTemplate>
                                                            <asp:Button ID="btnEditar" runat="server" class="btn mb-1  btn-primary btn-sm"
                                                                ...
                                                                .Eval(Container.DataItem, "Idreceitavariada")%>' />
                                                        </ItemTemplate>
                            ...
                            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Pesquisar receitas</h5>
                                            ...
                                            <ContentTemplate>
                                                <div class="form-row">
                                                    <div class="form-group col-md-12">
                                                        <asp:Label ID="Label8" runat="server" Text="Label">Descrição receita: </asp:Label>
                    ...
                    <div class="bootstrap-modal">
                        ...
                        <div class="modal fade bd-example-modal-lg" id="CadastroModal" data-keyboard="false" data-backdrop="static" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Cadastro de receitas</h5>
                                    ...
                                    <div class="modal-body">
                                        <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                                            <ContentTemplate>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-12">
                                                        <asp:Label ID="Label1" runat="server" Text="Label">Descrição receitas: </asp:Label>
