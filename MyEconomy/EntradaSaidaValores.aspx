<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="EntradaSaidaValores.aspx.cs" Inherits="MyEconomy.EntradaSaidaValores" %>
                        ...
                        <div class="row">
                            <div class="col p-md-0">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"><a href="javascript:void(0)"> Pesquisar Entrada/Saída de valores </a></li>
                                </ol>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <ul class="mb-0 form-profile__icons">
                                                    ...
                                                    <li class="d-inline-block">
                                                        <button type="button" class="btn btn-outline-light" title="Nova Entrada/Saída" data-toggle="modal" data-target="#CadastroModal"><i class="fa fa-plus"></i></button>

                                                    </li>
                                                    <li class="d-inline-block">
                                                        <button type="button" class="btn btn-outline-light" title="Pesquisar Entrada/Saída" data-toggle="modal" data-target="#basicModal"><i class="fa fa-search"></i></button>
                                                    </li>
                            ...
                            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Pesquisar Entrada/Saída</h5>
                                               ...
                                               <div class="form-row">
                                                <div class="form-group col-md-12">
                                                          <asp:Label ID="Label10" runat="server" Text="Label">Tipo: </asp:Label> 
                                                           <asp:DropDownList ID="DropTipo" runat="server" CssClass="form-control form-control-" ValidationGroup="group">
                                                          
                                                         </asp:DropDownList>
                                                       <asp:RequiredFieldValidator ID="RequiredFieldValidator5" ValidationGroup="group" runat="server" class="text-danger"  InitialValue="0" ErrorMessage="* Campo obrigatório" ControlToValidate="DropTipo"></asp:RequiredFieldValidator>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                         <asp:Label ID="Label3" runat="server" Text="Label">Descrição Contas Bancária: </asp:Label>
